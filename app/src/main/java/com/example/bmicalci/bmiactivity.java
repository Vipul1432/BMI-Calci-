...
public class bmiactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intbmi<16)
        {
            mbmicategory.setText("You're in the underweight range");
        ...
        {
            mbmicategory.setText("Your BMI is just below the normal");
            mbackground.setBackgroundColor(R.color.black);
            mimageview.setImageResource(R.drawable.warning);
        }
        else if(intbmi<24.9 && intbmi>18.5 )
        {
            mbmicategory.setText("You're in the healthy weight range");
            mimageview.setImageResource(R.drawable.ok);
        }
        else if(intbmi <29.9 && intbmi>25)
        {
            mbmicategory.setText("Overweight");
            mbackground.setBackgroundColor(R.color.design_default_color_error);
            mimageview.setImageResource(R.drawable.warning);
        }
        else if(intbmi<34.9 && intbmi>30)
        {
            mbmicategory.setText("You're in the obese range");
            mbackground.setBackgroundColor(R.color.design_default_color_error);
            mimageview.setImageResource(R.drawable.warning);
        }
        else
